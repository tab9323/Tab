...
GROUP_ID = "-1002234223582"
CHANNEL_USERNAME = "https://t.me/+SCgV7yRZK3Q3YTA1"
...
def handle_attack(message):
    ...
    full_command = f"./imu {target} {port} {time_duration} 900"
